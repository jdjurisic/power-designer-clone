...
import com.se.ucservice.exception.*;
import com.se.ucservice.model.*;
import com.se.ucservice.repository.DocumentRepository;
...
public class DokumentService {
    ...
    String validateUrl = "http://localhost:8086/validate/usecase";
    String helpUrl = "http://localhost:8086/validate/help/usecase";
    ...
    public DDocument saveDocument(DDocument document){
        ...
        if(validate(document)){
            ...
            if(document.getPreviousVersionId()==null || document.getPreviousVersionId().equals("")){
                document.setPreviousVersionId(documentRepository.save(document).getId());
                //return documentRepository.save(document);
            }
...
//         return mergedDocument;
    ...
    public DDocument saveGeneratedFile(DDocument document) {
        return documentRepository.save(document);
    }
